...
build_firefox() {
    ...
    cp amo-metadata.json LICENSE background.js content.js content.css popup.html popup.css popup.js options.html options.css options.js colors.css "$FIREFOX_DIR"
